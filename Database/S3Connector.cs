...
namespace NeptuneSkillImporter.Database
{
    public class S3Connector
    {
        ...
        public async Task<IEnumerable<S3Object>> GetFiles(DateTime? from = null, DateTime? to = null)
        {
            ...
            return jobPosts.Where(x => x.Key.Length > 11);
        }

        public async Task<IEnumerable<JobPost>> GetFileContents(IEnumerable<S3Object> jobPostKeys)
        {
